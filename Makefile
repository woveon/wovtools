...
BINS-ENV=wov-env-loader wov-env-ops wov-env-common wov-env-build wov-env wov-cluster wov-kops wov-cluster-createdb wov-cluster-configdbnet wov-env-val wov_stage-select wov-git-check
